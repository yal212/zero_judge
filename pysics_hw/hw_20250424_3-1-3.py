from vpython import *
g = vector(0,-9.8,0)       #重力加速度(依各情況給定重力場)
size = 0.8              #球半徑
k = 100                 #彈力係數
m1 = 5.0                #球1的質量
m2 = 5.0                #球2的質量
...
#物件設定
spring = helix(radius = size/2, coils = 15, color = color.black, thickness = size/5)  #畫彈簧
...
ball_1.v = vector(10, 20, 0)      #球1初速 
ball_2.v = vector(0, -20, 0)       #球2初速
